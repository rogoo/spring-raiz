...
public class TestController {
    ...
    @Operation(description = "method to return a TEST V2", parameters = {@Parameter(name =
            "id", description = "id of test2", required = true), @Parameter(name = "name",
            description = "name of test", required = false)})
